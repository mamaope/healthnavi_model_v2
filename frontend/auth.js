...
class HealthNaviAuth {
    constructor() {
        this.API_URL = '/api/v2'; // Direct connection to backend
    ...
    updateAuthUI() {
        ...
        if (this.currentTab === 'login') {
            ...
            subtitle.textContent = 'Sign in to your HealthNavi account';
        } else {
            title.textContent = 'Create Account';
            subtitle.textContent = 'Join HealthNavi AI today';
        }
    }
    ...
    showSupport() {
        this.showMessage('Support: support@healthnavi.ai', 'info');
    }
}
